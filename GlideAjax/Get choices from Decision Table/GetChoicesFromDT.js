...
GetChoicesFromDT.prototype = Object.extendsObject(global.AbstractAjaxProcessor, {
	 ...
	 * resultColumn must be set to the technical name of the result column that has the choices set.
        ...
        var dtInput2 = 'u_catalog_variable'; // Make sure you set this to the technical name of the second input of your Decision Table, if you have one. Multiple as needed, or remove if not.
