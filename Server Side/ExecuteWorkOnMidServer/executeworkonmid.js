...
queue - Name of your ECC queue entry to identify
topicName - Topic name of the ECC queue entry. This should be same as the topic name used by ServiceNow as it determines the type of work
source - The source which is issuing the work. This should be same as the source used by ServiceNow. It can also remain empty
work - XML payload which is the actual work that would be executed by mid server
...
function executeWorkOnMid(midServerName, queueName, topicName, source, work){
